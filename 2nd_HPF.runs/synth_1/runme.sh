...
HD_PWD='C:/Users/adity/OneDrive/Desktop/vivado_ws/2nd_HPF/2nd_HPF.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log filter_hpf.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source filter_hpf.tcl
